...
adb shell "pm disable-user --user 0 com.microntek.chooseui" ::Themes
adb shell "pm disable-user --user 0 com.microntek.backview" ::Rear Camera
adb shell "pm disable-user --user 0 com.microntek.frontview" ::Front Camera
...
::adb shell "pm disable-user --user 0 net.osmand"
...
::adb shell "pm disable-user --user 0 com.android.launcher3q"
...
::adb shell "pm disable-user --user 0 org.sdrpp.sdrpp"
